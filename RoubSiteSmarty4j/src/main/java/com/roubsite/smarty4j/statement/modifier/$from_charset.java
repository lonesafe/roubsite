...
/**
 * This is used to transcode a string from a given charset to the internal charset.
 * 
 * <table border="1">
 ...
 * @soubSite Smarty1.0
 */
public class $from_charset extends Modifier {
	...
	public void parse(MethodVisitorProxy mv, int local, VariableManager vm) {
		...
		mv.visitMethodInsn(INVOKESPECIAL, "java/lang/String", "<init>", "([BLjava/lang/String;)V");
	}
}