...
public class ClassUtils {
    ...
    public ClassBean getClassBean(String servletPath) {
        ...
        String defaultGroup = ConfUtils.getConf("default.group", "config.properties", new String[]{"RoubSite", "global", "defaultGroup"});
        ...
        // 获取类前缀
        String className = ConfUtils.getConf("global.group." + s[1], "config.properties", new String[]{"RoubSite", "global", "group", "" + s[1]});
