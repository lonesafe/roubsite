...
public class CodeSign {
    ...
    CodeSign(String pack, String _modeName, String modeName, String groupName, String _keyField, String keyField, String dataSource, String tableName, List<BeanField> searchFields, List<BeanField> allFields) {
        this.pack = pack;
    ...
    public void replaceAll(String inFilePath, String outFilePath) {
        ...
        try {
            ...
            conf.setEncoding(Locale.ENGLISH, "UTF-8");
            // 加载模板
